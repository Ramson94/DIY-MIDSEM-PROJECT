...
Project Objectives
Build a simple DIY environmental monitoring system.

Measure indoor temperature, relative humidity, and CO2 concentration.

Store sensor readings automatically on a microSD card.

Compare temperature and relative humidity readings from the SHT40 and SCD30 sensors.

Observe how indoor conditions change when the air conditioner is turned on or off.
...
Wiring Summary
SHT40 Sensor
SHT40 Pin	Arduino Uno Pin
VCC/VIN	5V or 3.3V, depending on the breakout board
GND	GND
SDA	A4 / SDA
SCL	A5 / SCL
SCD30 Sensor
SCD30 Pin	Arduino Uno Pin
VCC/VIN	5V or 3.3V, depending on the breakout board
GND	GND
SDA	A4 / SDA
SCL	A5 / SCL
The SHT40 and SCD30 both use I2C communication, so they share the same SDA and SCL lines.
